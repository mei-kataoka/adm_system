...
<div class="container">
        ...
        <div class="col-md-10 col-md-offset-2">
            ...
            <form class="form-inline my-2 my-lg-0 ml-2 user-search-form ">
                ...
                <div class="form-group">
                    ...
                    <select name="categoryId" id='category' class="form-control " value="{{request('categoryId')}}">
    ...
    <table class="table table-striped user-table tbody">
        ...
        <tr class='table-row'>
            ...
            <td>
                @csrf
                <button form method="POST" class='btn btn-primary' action="{{ route('delete',$product->id) }}" onSubmit="return checkDelete()" enctype="multipart/form-data">削除</button>
            </td>
        </tr>
        @endforeach
    </table>
