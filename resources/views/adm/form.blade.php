    ...
    <div class="col-md-8 col-md-offset-2">
        ...
        <form method="POST" action="{{ route('store') }}" onSubmit="return checkSubmit()" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="comment" name="comment" class="form-control commentArea" rows="4" value="{{ old('comment') }}">
                </textarea>
            ...
            <div class="form-group">
                ...
                ?>
                <input id="imgPath" name="img_path" class="form-control" value="{{ old('img_path') }}" type="file" enctype=”multipart/form-data” accept=".png, .jpg">
